...
const N4LModule = {
    ...
    showN4LMetadata(result) {
        ...
        // Causal Chains Section (NEW - N4L Advanced)
                    ...
                    <div class="n4l-section-content n4l-collapsed">
                        ...
                        <div class="n4l-chains-list">
                            ${result.causal_chains.map((chain, i) => `
                                <div class="n4l-chain-item" onclick="console.log('Chain clicked:', ${i}); app.highlightCausalChain(${i})" title="Cliquer pour visualiser">
        ...
        // Cross References Section (NEW - N4L Advanced)
        ...
        // Implicit Markers Section (NEW - N4L Advanced)
    ...
    toggleN4LFullscreen() {
        ...
        const graphContainer = document.getElementById('n4l-graph-container');
        ...
        // Redraw graph after transition with proper container sizing
        setTimeout(() => {
            if (this.n4lGraph) {
                // Force container to recalculate dimensions
                if (graphContainer) {
                    const rect = graphContainer.getBoundingClientRect();
                    console.log('N4L Fullscreen: container size =', rect.width, 'x', rect.height);
                }
                this.n4lGraph.redraw();
                this.n4lGraph.fit();
            }
